    ...
    <div className="rounded-xl border border-border bg-background-card p-4">
      ...
      {picked.length === 0 && !error && (
        <p className="text-xs text-muted-foreground">
          {/* Three cases, and the order matters: an unconfigured deployment
              has nothing useful to say about main images, and the dedicated
              page has no product-page fallback to describe. */}
          {!AUDIT_AVAILABLE
