  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-background-card border border-border rounded-xl p-8 text-center">
        <p className="text-text-secondary">Account settings coming soon...</p>
        <p className="text-text-muted text-sm mt-2">This page will allow you to manage your account and preferences.</p>
      </div>
    </div>
  )
}
